/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/alacritty
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/bleachbit
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/cpupower_gui
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/fusuma
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/logid
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/nitrogen
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/picom
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/qtile
/usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/sublime-text/Packages/User
...
# /usr/bin/git --git-dir=$HOME/.dotfiles2/ --work-tree=$HOME add .config/minidlna
